...
public class UserRepositoryMock implements UserRepository {
    private UserEntity mock_saved_user = new UserEntity();

    public UserRepositoryMock() {
        mock_saved_user.setId(1L);
        mock_saved_user.setName("David");
        mock_saved_user.setCpf("000.000.000-12");
        mock_saved_user.setEmail("david@email.com");
        mock_saved_user.setPassword("123");
    ...
    public Optional<UserEntity> findById(Long id) {
        return Optional.of(mock_saved_user);
    }
